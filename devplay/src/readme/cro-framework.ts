...
import type { DevPlayConfig, ProjectManifest, FeatureConfig, MetricConfig } from '../parser/types.js';
...
function generateHeroSection(config: DevPlayConfig): string {
...
function generateQuickStartSection(config: DevPlayConfig): string {
...
function generateInteractiveDemoSection(config: DevPlayConfig): string {
...
function generateContributingSection(config: DevPlayConfig): string {
  return `## 🤝 Contributing
