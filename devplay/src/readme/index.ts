...
import type { ProjectManifest, DevPlayConfig, ReadmeResult } from '../parser/types.js';
 ...
 */
function generateSimpleReadme(manifest: ProjectManifest, config: DevPlayConfig): string {
