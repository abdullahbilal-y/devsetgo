...
[![npm version](https://img.shields.io/badge/npm-v1.0.0-0969da?style=for-the-badge)](https://www.npmjs.com/package/devplay)
...
`devplay` solves this by compiling your code into **WebAssembly browser modules** and generating **CRO-optimized documentation** — all from a single CLI command.
...
Try devplay directly in your browser — no installation required:
...
<a href="https://calendly.com/devplay/discovery">
...
| Command | Description |
|---------|-------------|
| `devplay init` | Initialize configuration for your project |
| `devplay build` | Build everything: playground, README, and assets |
| `devplay readme` | Generate a CRO-optimized README only |
| `devplay playground` | Generate the interactive browser playground only |
| `devplay assets` | Generate architecture diagrams and social cards only |
| `devplay serve` | Start a local dev server with hot-reload |
...
**Made with ❤️ by the [devplay](https://github.com/devplay/devplay) team**
