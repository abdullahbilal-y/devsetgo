/**
 * devsetgo — Social Card Generator
 *
...
import type { DevSetGoConfig, ProjectManifest, GeneratedFile, SocialCardSize } from '../parser/types.js';
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${width} ${height}" width="${width}" height="${height}">
  ...
  <!-- devsetgo branding -->
  <text x="${width - padding}" y="${height - padding}" fill="${textSecondary}" font-family="Inter, Arial, sans-serif" font-size="${metricLabelSize}" font-weight="500" text-anchor="end" opacity="0.5">Built with devsetgo</text>
</svg>`;
}
